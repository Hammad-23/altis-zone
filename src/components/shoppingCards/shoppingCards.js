...
const ShoppingCards = () => {
    ...
    return (
        ...
        <Container>
            ...
            <Row style={{paddingTop:'13%', fontFamily:'sans-serif', paddingBottom:'5%'}}>
                <Col xl={8} lg={8} md={12} sm={12} xs={12} style={{border:"solid none"}}>
                   <Row >
                       <Col xl={1} lg={1} md={1} sm={1} xs={1}></Col>
                       <Col>
                       <div className='my-cart'><p>My Cart</p></div>
                       <div style={{borderBottom:'1px solid lightgray', marginTop:'2.5%'}}></div>
                       </Col>
                   </Row>
                   ...
                   {shoppingData.map((item)=>{
                       return(
                        ...
                        <Col xl={1} lg={1} md={1} ></Col>
                          <Col xl={2}lg={3} md={3} sm={5} xs={5} style={{border:'solid none'}}>
                              <div className='image'><img src={item.image} width={'100px'}/></div>
                          </Col>
                          <Col xl={3} lg={3} md={3} sm={7} xs={7} style={{border:'solid none'}}>
                               <div className='text-heading'><span>{item.name}</span></div>
                          ...
                          <Col xl={2} lg={5} md={5} sm={4} xs={4} style={{border:'solid none'}}>
                              <div style={{color:'gray'}} className='price-card'><p>$177.00</p></div>
                          </Col>
                          
                          <Col xl={1} lg={5} xs={3} style={{border:'solid none'}}>
                            <div className='close-icon'>  <IoCloseOutline style={{width:'25', height:'25'}}/></div>
                              
                          </Col>
                          <Row>
                              <Col xl={1}></Col>
                              <Col  style={{borderBottom:'1px solid lightgray', paddingTop:'5%',marginLeft:'1%' }}></Col>
                          </Row>
                   </Row>
                ...
                <Col xl={3} lg={4} md={12}sm={12} xs={12}  style={{border:"solid none"}}>
                    <div className='card-parent'>
                        <div className='card-head'>
                            <Row>
                                <Col><p style={{fontSize:'25px'}}>Order Summary</p>
                                <div style={{borderBottom:'1px solid lightgray'}}></div>
                                </Col>
                            </Row>
                            <div className='card-body'>
                            <Row>
                                <Col><div className='subtotal'><p>Subtotal</p></div></Col>
                                <Col><div className='subtotal-prize'><p>$118.00</p></div></Col>
                            </Row>
                            <Row>
                                <Col><div className='shipping'><p>Shipping</p></div></Col>
                                <Col><div className='free'><p>FREE</p></div></Col>
                            </Row>
                            <Row>
                                <Col><div className='location'><a href='#'>sindh, pakistan</a></div>
                                </Col>
                                <div style={{borderBottom:'1px solid lightgray'}}></div>
                            ...
                            <div className='card-foot'>
                                <Row>
                                    <Col><div className='total'><p>Total</p></div></Col>
                                    <Col><div className='price'><p>$118.00</p></div></Col>
                                </Row>
                                <Row>
                                    <Col>
                                    <Button style={{
