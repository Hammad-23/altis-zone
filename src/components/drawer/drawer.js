      ...
      <Row>
        <Col>
          <Drawer
            ...
            direction="right"
            style={{ border: "solid none", width: "auto" }}
          >
            <Row>
              <Col>
                <div
                ...
                >
                  <h1 style={{ margin: "25px" }}>cart</h1>
                </div>
              </Col>
            </Row>
            <Scrollbars
              style={{ width: 500, height: 370, border: "solid none" }}
            >
            ...
            <div
              style={{ border: " 0.5px solid lightgray", marginTop: "3%" }}
            ></div>
            <Row>
