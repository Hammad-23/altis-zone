      ...
      <Row>
        <Col xs={12} sm={12} md={12} lg={12} xl={12}>
          <div className="home-TextDiv">
            <p className="home-Midd-Text">Home / MIDI PLEATED SKIRT</p>
          </div>
        </Col>
      </Row>
      <Row>
              ...
              <Col>
                ...
                >
                  <p>
                    ...
                    much information as possible so they can buy with confidence
                    and certainty.
                  </p>
                </div>
                ...
                <div className="mid-links">
                  <div class="links">
                    <a href="https://web.whatsapp.com/">
                      <IoLogoWhatsapp className="whats-aap" size={20} />
                    </a>
                    <a href="https://www.facebook.com/">
                      <FaFacebookF size={17} className="face-book" />
                    </a>
                    <a href="https://twitter.com/">
                      <FaTwitter size={18} className="twitter" />
                    </a>
                    <a href="https://www.pinterest.com/">
                      <FaPinterestP size={18} className="pin-test" />
                    </a>
                  </div>
                </div>
              </Col>
